...
import com.boke.quartz.QuartzDisallowConcurrentExecution;
import com.boke.quartz.QuartzJobExecution;

import org.quartz.*;

public class ScheduleUtil {

    private static Class<? extends org.quartz.Job> getQuartzJobClass(org.quartz.Job job) {
    ...
    public static void createScheduleJob(Scheduler scheduler, org.quartz.Job job) throws SchedulerException, TaskException {
